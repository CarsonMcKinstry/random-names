...
export default function superpowers() {
    ...
    const nm1 = [
        ...
        'Dermal Armor',
        'Destruction Magic',
        'Detach and Regenerate Limbs',
        'Diamond Skin',
        'Digital Form',
        'Disease Invulnerability',
        'Disintegrate Matter',
        'Disintegrate Objects',
        'Disintegrate Organisms',
        'Disorientating Pheromones',
        'Divination',
        'Dowsing',
        'Dream Manipulation',
        'Druid Magic',
        'Dual Minds',
        'Dusk Enhanced Strength',
        'Eagle Eyesight',
        'Echolocation',
        'Ecological Empathy',
        'Elasticity',
        ...
        'Enhanced Lock-picking',
        'Enhanced Lung Capacity',
        'Enhanced Marksmanship',
        'Enhanced Memory',
        'Enhanced Seductive Skills',
        'Enhanced Senses',
        'Enhanced Skeleton',
        'Enhanced Stealth',
        'Enhanced Thievery',
        'Enhanced Tracking Skills',
        'Escape Artist',
        'Evocation',
        ...
        'Generate Energy Constructs',
        'Generate Energy Life Forms',
        'Generate Energy Weapons',
        'Generate Light Bursts',
        'Generate Powerful Dusts',
        'Generate Volatile Constructs',
        'Healing Powers',
        'Heat Vision',
        'Hive Organism',
        ...
        'Power Bestowal',
        'Power Disabling',
        'Powerful Twins (Stronger Together)',
        'Precognition',
        'Prehensile Tongue',
        'Premonitions',
        'Pressure Manipulation',
        'Projected Mind Illusions',
        ...
        'Toxic Touch',
        'Tracking Evasion',
        'Transform into a gas state',
        'Transmutation',
        'Transmute Elements',
        'Transmute Minerals',
        'Twilight Enhanced Strength',
        'Twilight Manipulation',
        'Two Brains and Personalities',
        'Two extra arms with super strength',
        'Ultraviolet Vision',
        'Universal Irreversability',
        'Unstoppable Momentum',
        'Vacuum Adaptation',
        'Vampirism',
        'Venom Breath',
        'Venom Invulnerability',
        'Venom Spit',
        'Venom/Toxin Immunity',
