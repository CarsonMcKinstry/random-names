...
export default function basothos() {
    ...
    const nm1 = [
        'Amohelang (Receive)',
        'Amose (Burdened)',
        'Ata ((Increase/Multiply)',
        'Baholo (Elders)',
        'Bokang (Rejoice/Praise)',
        'Bongoe (One)',
        'Diboko (Praises)',
        'Dikotsi (Accidents)',
        'Esaia (God is my salvation)',
        'Hlompho (Respect)',
        'Kabelo ((Inheritance)',
        'Kabelo (Given)',
        ...
        'Lehlohonolo (Luck)',
        'Lekgotla (Court of law)',
        'Lekhotla (Court of law)',
        ...
        'Masingita (Miracle)',
        'Masopha (Chieftain)',
        'Moeketsi (Proliferator)',
        'Moeletsi (Advisor)',
        'Mohapi (Victor)',
        'Mohato (Step)',
        'Mohau (Pity/mercy)',
        'Mohlomi (Wisest of Leaders)',
        'Mojalefa (Heir)',
        'Mokgethi (Chooser)',
        'Mokhasi (Crawler)',
        'Mokhethi (Chooser)',
        ...
        'Mphafane (Praises God)',
        'Mpho (Gift)',
        'Neo (Gift)',
        'Nkoe (Tiger)',
        'Nkoeneane (Little Tiger)',
        'Nkoenyane (Little Tiger)',
        'Nku (Sheep)',
        'Nkwe (Tiger)',
        'Nkwenyane (Little Tiger)',
        'Nthofeela (Thing)',
        'Ntja (Dog)',
        'Ntsu (Eagle)',
        'Oagile (Firmly built household)',
        ...
        'Paseka (Easter)',
        'Phahamo (Eminence)',
        'Pheello (Perseverance)',
        'Pheko (Remedy/Cure)',
        'Phethisi (Completion/Execution)',
        'Phetoho (Change)',
        'Phutheho (Congregation)',
        'Polo (Alligator)',
        'Poloko (Safety)',
        ...
        'Refiloe (We have been given)',
        'Refilwe (We have been given)',
    ...
    const nm2 = [
        ...
        'Kananelo (Approval/Appreciation)',
        'Katleho (Success)',
        'Keneoue (I’ve been given)',
        "Keneuwe (I've been given)",
        ...
        'Reabiloe (We have been blessed)',
        'Reabilwe (We have been blessed)',
        'Refiloe (We have been given)',
        'Refilwe (We have been given)',
        'Relebohile (We are grateful)',
