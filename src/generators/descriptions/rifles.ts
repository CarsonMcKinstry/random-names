export default function rifles() {
    ...
    const nm2 = [
        'admired by many',
        'commissioned for many around the world',
        'desired across the globe',
        'famous around the world',
        'in high demand',
        'infamous around the world',
        'made a name for itself',
        'noted by many across the world',
        'praised by many',
        'prominent across the globe',
        'purchased and sold by many',
        'sold to people across the globe',
        'well-known across the world',
        'world renowned',
    ];
    const nm3 = [
        'celebrated for its consistent aim and accuracy',
        'celebrated for its precision and reliability',
        'known as a low cost, high value weapon',
    ...
    const nm10 = [
        'a few other calibers have been produced as well',
        ...
        'most other calibers are available',
        'one other caliber is available',
    ...
    const nm11 = [
        'an upper and lower receiver for easier maintenance',
    ...
    const nm19 = [
        'very common as well',
        'the next most common stock available',
        'high up on the list of demand',
        'often preferred instead',
        'used more often',
        'just as common and popular',
    ...
    const nm22 = [
        ...
        'the magazine comes in various sizes',
    ...
    const nm26 = [
        ...
        'preventing war through a show of power',
        'keeping the peace',
        'increasing security',
        'fighting crime on a bigger scale',
        'upgrading the existing inventory',
        'updating the existing inventory',
        'preparing for a likely war',
        'gaining the upper hand in a guerrilla war',
        'providing more versatility in terms of weapon choice',
        'increasing the amount of weapons available',
    ...
    const nm28 = [
        'There are a few other variants of this weapon',
