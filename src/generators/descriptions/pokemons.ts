export default function pokemons() {
    ...
    const darkTail = [
        'a tail much like a whip',
        'a tail that ends in a barbed tip',
        'a pair of tails instead of one',
        ...
        'a tail that seems to shimmer in light',
        'an incredibly fluffy tail',
    ...
    const dragonTail = [
        ...
        'a segmented tail',
        'a stubby tail',
        'a tail ending in a hammer',
        'a tail ending in double barbs',
        'a tail like a whip',
        'a thick tail',
        'an armor plated tail',
        'an incredibly long tail',
        'an incredibly powerful tail',
        'several tails',
    ];
    const elecSkin = [
        'yellow',
    ...
    const elecTail = [
        'a coiling tail',
        'a jagged tail',
        'a jagged, fan-like tail',
        'a lightning bolt tail',
        'a magnetized tail',
        'a pair of tails',
        'a positively and a negatively charged tail',
        'a sharp blade-like tail',
        'a stubby orb-like tail',
        'a tail ending in a charged orb',
        'a tail ending in a magnet',
        'a tail full of charged orbs',
        'a tail laden with electric charges',
        'a tail pulsing with electricity',
        'several tails',
    ];
    const elecEars = [
        'bolt-like',
    ...
    const fairyTail = [
        'a bioluminescent tail',
        'a decorated tail',
        'a fan-like tail',
        'a fluffy tail',
        'a glowing tail',
        'a long tail wrapped around its body',
        'a long, floating tail',
        'a long, forked tail',
        'a ribbon-like tail',
        'a short, stubby tail',
        'a sparkling tail',
    ...
    const fightTail = [
        'a leg-like tail',
        'a long tail used for superior balance',
        'a muscular tail',
        'a nimble and strong tail',
        'a prehensile tail',
        'a ribbon-like tail',
        'a set of prehensile tails',
        'a set of tails like a fan',
        'a set of two powerful tails',
        'a tail ending in a fist-like extremity',
        'a tail ending in a hammer',
        'a tail like a whip',
        'a tail that wraps around the body like a belt',
    ];
    const fightEars = [
        'a lack of',
        'bolt-like',
    ...
    const fireTail = [
        'a burning tail',
        'a flame-like tail',
        'a fluffy flame patterned tail',
        'a lava-like tail',
        'a literal flame as a tail',
        'a muscular',
        'a smoldering tail',
        'a stubby tail',
        'a tail like a fan',
        'a tail that ends in fire',
        'a tailpipe-like tail',
        'an obsidian tail',
    ...
    const flyTail = [
        ...
        'a powerful tail',
        'a puffy, round tail',
        'a rainbow colored tail',
        'a rather small tail',
        'a ribbon-like tail',
        'a set of tails',
        'an elongated tail',
        'an incredibly long, ribbon-like tail',
        'several tails in a fan-like shape',
        'two tails instead of one',
    ];
    const flyEars = [
        'an extra pair of',
    ...
    const ghostTail = [
        'a broad tail, ribbon-like tail',
        'a fan-like tail',
        'a gaseous tail',
        'a hovering tail',
        'a long tail floating gently in the air',
        'a long tail wrapped around its body',
        'a long, ribbon-like tail',
        'a spiky tail',
        'a tail like a cape',
        'several ribbon-like tails',
        'several tails instead of one',
        'two tails instead of one',
    ];
    const ghostEars = [
    ...
    const grassTail = [
        ...
        'a leafy tail',
        'a moss covered tail',
        'a mostly overgrown tail',
        'a mushroom as a tail',
        'a needle-like tail',
        'a stubby tail',
        'a tail full of flowers',
        'a thorny tail',
        'a trunk-like tail',
        'a vine-like tail',
        'an evergrowing tail',
    ...
    const groundTail = [
        ...
        'a short, stubby tail',
        'a shovel-like tail',
        'a strong and nimble tail',
        'a stubby tail',
        'a tail suitable for digging',
        'an armor plated tail',
        'several tails instead of one',
        'two tails instead of one',
    ];
    ...
    const iceSnout = [
        ...
        'smirking',
        'stubby',
        'thinly icicle-covered',
        'tranquil looking',
    ];
    const iceTail = [
        'a broad, fan-like tail',
        'a fluffy tail',
        'a frost covered tail',
        'a frosty tail',
        'a long, fluffy tail wrapped around its body',
        'a ribbon-like tail',
        'a short and stubby tail',
        'a tail wrapped around its body like a scarf',
        'an icicle covered tail',
        'an icicle-like tail',
        'an icy, reflective tail',
        'several tails instead of one',
        'two tails instead of one',
    ];
    const iceEars = [
    ...
    const psyTail = [
        ...
        'a bioluminescent tail',
        'a forked tail',
        'a long, decorated tail',
        'a long, muscular tail',
        'a ribbon-like tail',
        'a spiky tail',
        'a tail ending in a crescent shape',
        'a tail that ends in a fan-like shape',
        ...
        'a tail with a crystal on its tip',
        'a tail with a gem on its tip',
        'an armored tail',
        'an incredibly long tail',
        'several tails instead of one',
        'two tails instead of one',
    ...
    const rockMouth = [
        ...
        'small',
        'stalactite toothed',
        'stalgmite and stalactite toothed',
        'stone',
        'tusked',
    ];
    const rockBeak = [
    ...
    const rockTail = [
        ...
        'a strong and nimble tail',
        'a stubby tail',
        'a tail full of stalactites',
        'a tail like a stalactite',
        'a tail like a stalagmite',
        'a tail suitable for digging',
        'an armor plated tail',
    ];
    const rockEars = [
    ...
    const steelTail = [
        'a blade-like tail',
        'a fan-like tail',
        'a forked, blade-like tail',
        'a glowing, bioluminescent tail',
        'a glowing, metallic tail',
        'a long tail wrapped around its body',
        'a long, energized tail',
        'a long, spiky tail',
        'a magnetized tail',
        'a metal scaled tail',
        'a short, spike-like tail',
        'a short, stumpy tail',
        'a tail ending in a massive orb-like shape',
        'a tail ending in a u-shape magnet',
        'a thick, reflective tail',
        'an armor plated tail',
        'an elongated tail',
        'several tails instead of one',
        'two tails instead of one',
    ...
    const waterTail = [
        'a bioluminescent tail',
        'a broad, fan-like tail',
        'a coral covered tail',
        'a forked tail',
        'a glowing tail',
        'a huge, cloak-like tail',
        'a long, curled up tail',
        'a long, ribbon-like tail',
        'a long, smooth tail',
        'a long, wavy tail',
        'a ridged tail',
        'a shell covered tail',
        'a short and tiny tail',
        'a strong, muscular tail',
        'a stubby, fin-like tail',
        'several tails instead of one',
        'two tails instead of one',
    ];
    const waterEars = [
    ...
    const placeIce = [
        ...
        'in icy cave systems',
        'in snowlands',
        'in snowy mountain peaks',
        'in taigas',
        'in tundras',
        'in winter',
        'on cold mountain peaks',
        'on frozen lakes',
        'on frozen rivers',
        'on icy plains',
    ];
    ...
    const placeRock = [
        ...
        'in rocky mountains',
        'near cliffs',
        'on and near hillsides',
        'on and near mountains',
        'on mountain peaks',
        'on rocky paths',
    ];
    const placeSteel = [
    ...
    const placeWater = [
        ...
        'in serene lakes',
        'in swampy areas',
        'in wild water rapids',
        'near beaches',
        'near calm shores',
        'near coral reefs',
        'near ocean fronts',
        'near sea fronts',
        'near steep coastal areas',
        'near waterfalls',
        'on oceanic islands',
    ];
    const pers = [
    ...
    const amnt = [
        'all around you',
        'alone or alongside one or two others',
        'alongside a few others',
        'alongside other Pokemon',
        'among many other kinds of Pokemon',
        'hidden away and on their own',
        'hiding with several others',
        'in huge groups',
        'in small groups',
        'lurking about and on their own',
        'lurking with several others',
        'on their own',
        'only after giving up your search for them',
        'only by accident',
    ];
    const wtr = [
        'dark',
    ...
    const evo = [
        'could still evolve, but it requires a special stone',
    ...
    let pkm = [
        ['an aardvark', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'an albatross',
            ['air', 'water'],
            ['feathers'],
        ...
        ['an alpaca', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['an ant', ['land'], ['skin'], ['legs'], 'mouth', 'none', 'none'],
        ['an anteater', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['an antelope', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'an ape',
            ['land'],
            ['skin', 'fur'],
        ...
        ['an armadillo', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a baboon',
            ['land'],
            ['skin', 'fur'],
        ...
        ['a badger', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a barracuda',
            ['water'],
            ['scales'],
        ...
        ['a bat', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'ears'],
        ['a bear', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        [
            'a beaver',
            ['land', 'water'],
            ['fur'],
        ...
        ['a bee', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        ['a bird', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a bison', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a boar',
            ['land'],
            ['skin', 'hide'],
        ...
        ['a butterfly', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        ['a camel', ['land'], ['hide'], ['legs'], 'snout', 'tail', 'ears'],
        ['a caribou', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        [
            'a cassowary',
            ['air', 'land'],
            ['feathers'],
        ...
        ['a cat', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        [
            'a caterpillar',
            ['land'],
            ['skin'],
        ...
        ['a cheetah', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        [
            'a chicken',
            ['air', 'land'],
            ['feathers'],
        ...
        ['a chinchilla', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        [
            'a cobra',
            ['land'],
            ['skin', 'scales'],
        ...
        ['a cockroach', ['land'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        ['a cod', ['water'], ['scales'], ['fins'], 'mouth', 'none', 'none'],
        [
            'a cow',
            ['land'],
            ['skin', 'hide'],
        ...
        ['a coyote', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a crab',
            ['land', 'water'],
            ['armor'],
        ...
        ['a crow', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a deer', ['land'], ['fur'], ['legs'], 'snout', 'none', 'horns'],
        ['a dinosaur', ['land'], ['skin'], ['legs'], 'snout', 'tail', 'none'],
        ['a dog', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a dolphin', ['water'], ['skin'], ['fins'], 'mouth', 'none', 'none'],
        ['a donkey', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a dove', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a dragonfly', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        [
            'a duck',
            ['air', 'land', 'water'],
            ['feathers'],
        ...
        ['an eagle', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['an eel', ['water'], ['skin'], ['body'], 'mouth', 'tail', 'none'],
        [
            'an eland',
            ['land'],
            ['skin', 'fur'],
        ...
        ['an elk', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        [
            'an emu',
            ['air', 'land'],
            ['feathers'],
        ...
        ['a falcon', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a ferret', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a fish', ['water'], ['scales'], ['fins'], 'mouth', 'none', 'none'],
        [
            'a flamingo',
            ['air', 'land', 'water'],
            ['feathers'],
        ...
        ['a fly', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        ['a fox', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a frog',
            ['land', 'water'],
            ['skin'],
        ...
        ['a gazelle', ['land'], ['hide'], ['legs'], 'snout', 'tail', 'horns'],
        ['a gerbil', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a giraffe',
            ['land'],
            ['skin', 'hide'],
        ...
        ['a gnu', ['land'], ['hide'], ['legs'], 'snout', 'tail', 'horns'],
        ['a goat', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'horns'],
        [
            'a goose',
            ['air', 'water'],
            ['feathers'],
        ...
        ['a guinea pig', ['land'], ['fur'], ['legs'], 'mouth', 'none', 'ears'],
        [
            'a gull',
            ['air', 'land', 'water'],
            ['feathers'],
        ...
        ['a hamster', ['land'], ['fur'], ['legs'], 'mouth', 'none', 'ears'],
        ['a hare', ['land'], ['fur'], ['legs'], 'mouth', 'none', 'ears'],
        ['a hawk', ['air'], ['feathers'], ['wings'], 'beak', 'none', 'none'],
        ['a hedgehog', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        ['a herring', ['water'], ['scales'], ['fins'], 'mouth', 'none', 'none'],
        [
            'a hippopotamus',
            ['land', 'water'],
            ['skin'],
        ...
        ['a hornet', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        [
            'a horse',
            ['land'],
            ['hide', 'hair'],
        ...
        ['an ibex', ['land'], ['hide'], ['legs'], 'snout', 'none', 'horns'],
        [
            'an ibis',
            ['air', 'land', 'water'],
            ['feathers'],
        ...
        ['a jackal', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a jaguar', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        [
            'a jellyfish',
            ['water'],
            ['skin'],
        ...
        ['a kangaroo', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a koala', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        [
            'a komodo dragon',
            ['land'],
            ['skin'],
        ...
        ['a kudu', ['land'], ['hide'], ['legs'], 'snout', 'tail', 'horns'],
        ['a lark', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a lemur', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        ['a leopard', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        [
            'a lion',
            ['land'],
            ['fur', 'hair'],
        ...
        ['a llama', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        ['a lobster', ['water'], ['armor'], ['arms'], 'mouth', 'tail', 'none'],
        ['a locust', ['land'], ['skin'], ['legs'], 'mouth', 'none', 'none'],
        [
            'a lyrebird',
            ['air'],
            ['feathers'],
        ...
        ['a magpie', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a mammoth', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        ['a manatee', ['water'], ['skin'], ['fins'], 'snout', 'none', 'none'],
        ['a mandrill', ['land'], ['fur'], ['legs'], 'mouth', 'none', 'ears'],
        ['a mole', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        ['a mongoose', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a monkey',
            ['land'],
            ['skin', 'fur'],
        ...
        ['a moose', ['land'], ['fur'], ['legs'], 'snout', 'none', 'horns'],
        ['a mosquito', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        ['a mouse', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a narwhal', ['water'], ['skin'], ['fins'], 'mouth', 'none', 'none'],
        ['a newt', ['land'], ['skin'], ['legs'], 'mouth', 'tail', 'none'],
        [
            'a nightingale',
            ['air'],
            ['feathers'],
        ...
        ['an okapi', ['land'], ['hide'], ['legs'], 'snout', 'tail', 'none'],
        ['an opossum', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'an ostrich',
            ['air', 'land'],
            ['feathers'],
        ...
        ['an owl', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a panda', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        ['a panther', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        ['a parrot', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        [
            'a partridge',
            ['air', 'land'],
            ['feathers'],
        ...
        ['a pig', ['land'], ['skin'], ['legs'], 'snout', 'tail', 'ears'],
        ['a pigeon', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a pony', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a porcupine', ['land'], ['fur'], ['legs'], 'snout', 'none', 'none'],
        ['a prairie dog', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        [
            'a quail',
            ['air', 'land'],
            ['feathers'],
        ...
        ['a rabbit', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        ['a raccoon', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a ram', ['land'], ['fur'], ['legs'], 'mouth', 'none', 'horns'],
        ['a rat', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a raven', ['air'], ['feathers'], ['wings'], 'beak', 'tail', 'none'],
        ['a reindeer', ['land'], ['fur'], ['legs'], 'snout', 'none', 'horns'],
        ['a rhinoceros', ['land'], ['skin'], ['legs'], 'mouth', 'tail', 'ears'],
        [
            'a salamander',
            ['land', 'water'],
            ['skin'],
        ...
        ['a salmon', ['water'], ['scales'], ['fins'], 'mouth', 'none', 'none'],
        ['a sardine', ['water'], ['scales'], ['fins'], 'mouth', 'none', 'none'],
        ['a sea lion', ['water'], ['skin'], ['fins'], 'mouth', 'none', 'none'],
        ['a seahorse', ['water'], ['skin'], ['fins'], 'snout', 'tail', 'ears'],
        [
            'a seal',
            ['land', 'water'],
            ['skin'],
        ...
        ['a shark', ['water'], ['skin'], ['fins'], 'mouth', 'none', 'none'],
        ['a sheep', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        ['a skunk', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a sloth', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'none'],
        [
            'a snake',
            ['land', 'water'],
            ['scales'],
        ...
        ['a spider', ['land'], ['skin'], ['legs'], 'mouth', 'none', 'none'],
        ['a squirrel', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a swan', ['water'], ['feathers'], ['wings'], 'beak', 'none', 'none'],
        ['a tapir', ['land'], ['hide'], ['legs'], 'snout', 'none', 'ears'],
        ['a tarsier', ['land'], ['fur'], ['legs'], 'mouth', 'none', 'ears'],
        ['a termite', ['land'], ['skin'], ['legs'], 'mouth', 'none', 'none'],
        ['a tiger', ['land'], ['fur'], ['legs'], 'mouth', 'tail', 'ears'],
        ['a toad', ['land'], ['skin'], ['legs'], 'mouth', 'none', 'none'],
        [
            'a turkey',
            ['air', 'land'],
            ['feathers'],
        ...
        ['a wallaby', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        [
            'a walrus',
            ['land', 'water'],
            ['skin'],
        ...
        ['a wasp', ['air'], ['skin'], ['wings'], 'mouth', 'none', 'none'],
        ['a weasel', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a whale', ['water'], ['skin'], ['fins'], 'mouth', 'none', 'none'],
        ['a wolf', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a wolverine', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
        ['a wombat', ['land'], ['fur'], ['legs'], 'snout', 'none', 'ears'],
        ['a yak', ['land'], ['fur'], ['legs'], 'snout', 'none', 'horns'],
        ['a zebra', ['land'], ['fur'], ['legs'], 'snout', 'tail', 'ears'],
    ];
    const traits = [];
    let pkType = '';
